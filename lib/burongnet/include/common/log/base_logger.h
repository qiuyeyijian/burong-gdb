...
class BaseLogger {
 public:
  ...
  void Debug(const char* file, uint32_t line, const char* content,
             va_list list);
  ...
  void Error(const char* file, uint32_t line, const char* content,
             va_list list);
  void Fatal(const char* file, uint32_t line, const char* content,
             va_list list);
