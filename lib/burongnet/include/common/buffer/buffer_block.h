...
class BufferBlock : public InnerBuffer, public ListSlot<BufferBlock> {
 public:
  ...
  bool GetFreeMemoryBlock(void*& res1, uint32_t& len1, void*& res2,
                          uint32_t& len2);
  ...
  // len1: length of memory.
  // there may be two blocks
  bool GetUseMemoryBlock(void*& res1, uint32_t& len1, void*& res2,
                         uint32_t& len2);
 ...
 private:
  // find str in fix length buffer. return the first position if find otherwise
  // return nullptr
