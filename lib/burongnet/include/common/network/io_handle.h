...
class OsHandle {
 public:
  ...
  static SysCallInt32Result Write(int64_t sockfd, const char* data,
                                  uint32_t len);
  static SysCallInt32Result Writev(int64_t sockfd, Iovec* vec,
                                   uint32_t vec_len);

  static SysCallInt32Result Recv(int64_t sockfd, char* data, uint32_t len,
                                 uint16_t flag);
