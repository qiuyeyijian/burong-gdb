...
TimerSlot::TimerSlot() : _total_interval(0), _left_interval(0) {}
...
uint32_t TimerSlot::GetLeftInterval() { return _left_interval; }
...
void TimerSlot::SetInTimer() { _total_interval |= TSF_IN_TIMER; }

bool TimerSlot::IsInTimer() { return _total_interval & TSF_IN_TIMER; }

void TimerSlot::RmInTimer() { _total_interval &= ~TSF_IN_TIMER; }

void TimerSlot::SetAlways() { _total_interval |= TSF_ALWAYS; }

bool TimerSlot::IsAlways() { return _total_interval & TSF_ALWAYS; }

void TimerSlot::RmAlways() { _total_interval &= ~TSF_ALWAYS; }
